...
$(function () { // This runs when the DOM is ready
    ...
    // ... (other code for smooth scroll, navbar, etc.) ...
    ...
    tl.to(".loader-wrap-heading .load-text , .loader-wrap-heading .cont", {
        delay: 1.5, // Start fading after 1.5 seconds
        y: -100,
        opacity: 0,
    });
    tl.to(svg, {
    ...
    tl.to(".loader-wrap", {
        y: -1500, // Move the entire loader off-screen upwards
    });
    tl.to(".loader-wrap", {
        zIndex: -1,
        display: "none", // Finally hide it
    });
    tl.from(
        "header .container", // This is an animation for your main page content
        {
            y: 100,
            opacity: 0,
            delay: 0.3, // This delay is relative to the *start* of this animation in the timeline
        },
        "-=1.5" // This makes it start 1.5 seconds before the *end* of the previous animation
    );
});